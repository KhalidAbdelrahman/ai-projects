...
url = f"https://api.open-meteo.com/v1/forecast?latitude=30.044420&longitude=31.235712&start_date={start_date}&end_date={end_date}&daily=temperature_2m_max,temperature_2m_min"
...
df.to_csv('data/cairo_weather.csv', index=False)
